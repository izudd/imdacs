...
// MONITRA sub-components
import MonitraDashboard from './monitra/MonitraDashboard';
import MonitraPT from './monitra/MonitraPT';
import MonitraAssignments from './monitra/MonitraAssignments';
import MonitraDailyReports from './monitra/MonitraDailyReports';
import MonitraVisitLogs from './monitra/MonitraVisitLogs';
import MonitraArchive from './monitra/MonitraArchive';
import MonitraProgressAudit from './monitra/MonitraProgressAudit';
                ...
                <div className="divide-y divide-slate-50">
                  {memberClients.length === 0 ? (
                    ...
                    memberClients.map(client => (
                      <div key={client.id} onClick={() => setSelectedClient(client)} className="p-3 hover:bg-slate-50 cursor-pointer transition-colors">
